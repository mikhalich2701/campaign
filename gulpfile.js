...
gulp.task("build", ["clean", "img", "sass", "scripts"], function () {
   ...
   var fontsBuild = gulp.src("app/fonts/**/*").pipe(gulp.dest("dist/fonts"));

   var jsBuild = gulp.src("app/js/**/*").pipe(gulp.dest("dist/js"));

   var htmlBuild = gulp.src("app/**.html").pipe(gulp.dest("dist"));
});
